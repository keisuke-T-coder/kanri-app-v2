...
import { CLIENT_TABS } from "../_types/schema";
      ...
      <div className="sticky top-0 z-10 glass border-b border-black/5 p-4 space-y-4">
        <div className="relative max-w-2xl mx-auto">
          ...
          <input
            ...
            className="w-full bg-white border border-slate-200 rounded-2xl py-4 pl-12 pr-12 text-sm font-bold outline-none focus:ring-2 focus:ring-primary/20 transition-all text-slate-800"
          />
          {query && (
            <button
              onClick={() => setQuery("")}
              className="absolute right-4 top-1/2 -translate-y-1/2 p-1 bg-slate-200 rounded-full"
            >
        ...
        <div className="max-w-2xl mx-auto flex space-x-2 overflow-x-auto no-scrollbar pb-1">
          <select
            ...
            className="flex-none bg-white border border-slate-200 rounded-xl px-4 py-2 text-xs font-black outline-none appearance-none text-slate-700 shadow-sm"
          >
